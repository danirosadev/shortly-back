...
--
-- Name: user_urls user_urls_url_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.user_urls
    ADD CONSTRAINT user_urls_url_id_fkey FOREIGN KEY (url_id) REFERENCES public.urls(id);
